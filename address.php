                            ...
                            <div class="main-dashboard">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-2">
                                        ...
                                        <li class="active"><a class="active" href="address.php"><i class="icon-map-marker"></i> Address</a></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control" name="zipcode" type="text" value="<?php echo $row['zip'] ?>">
                                            </div>
                                        </div>
									  ...
									  if(isset($_REQUEST['upd'.$id]))
									   {
                                          ...
                                          $q = "UPDATE register SET address = '$address', city='$city', state='$state', country='$country', zip='$zipcode' WHERE u_id = '$id'";
									      mysqli_query($con,$q);
										  echo "<script>window.location.replace('address.php')</script>";
								   }
								   } } ?>
            </div> <!-- end of row -->
