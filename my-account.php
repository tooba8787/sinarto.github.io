                            ...
                            <div class="main-dashboard">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-2">
										...
										<li class="active"><a href="orderhistory.php"><i class="icon-user"></i>Orders</a></li>
									  ...
									  if(isset($_REQUEST['upd'.$id]))
									   {
                                          ...
                                          $q = "UPDATE register SET fname = '$fname', lname='$lname', phone='$phone', dob='$dob', email='$email' WHERE u_id = '$id'";
									      mysqli_query($con,$q);
										  echo "<script>window.location.replace('my-account.php')</script>";
								   }
